...
struct _R {
  ...
  struct string {
    ...
    struct errors {
      ...
      /// en translation: You have not filled in all the fields. Fill it out and try again
      ///
      /// Key: empty_fields
      ///
      /// Locales: en, ru
      var empty_fields: RswiftResources.StringResource { .init(key: "empty_fields", tableName: "Errors", source: source, developmentValue: "You have not filled in all the fields. Fill it out and try again", comment: nil) }
